...
//        add(lblbranch);
//
//        String branch[] = {"Computer Science", "Electronics", "IT", "Civil", "BioMedical", "Mechanical", "Chemical Engineering", "AI-DS", "AI-ML"};
...
//        submit.setFont(new Font("Tohoma", Font.BOLD, 15));
//        add(submit);
//        
//        
...
//           try{
//               String query = "INSERT INTO student (name, fname, rollno, dob, address, phone, email, class10_percentage, class12_percentage, aadhar, course, branch) " +
//               "VALUES ('" + name + "', '" + fname + "', '" + rollno + "', '" + dob + "', '" + address + "', '" + phone + "', '" + email + "', " +
//               x + ", " + xii + ", '" + aadhar + "', '" + course + "', '" + branch + "')";
//               
//               Conn con = new Conn();
//               con.s.executeUpdate(query);
//               JOptionPane.showMessageDialog(null,"students deatails updated successfully");
//               setVisible(false);
//
//           }catch (Exception e){
//               e.printStackTrace();
